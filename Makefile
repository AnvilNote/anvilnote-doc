...
.PHONY: help install dev build start lint typecheck check format test clean reset

# Show this help message when make runs without a target.
.DEFAULT_GOAL := help

help: ## List all available targets with a short description
	@echo "AnvilNote doc - available make targets:"
